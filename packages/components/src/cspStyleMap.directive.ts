...
import type { AttributePart, DirectiveParameters, DirectiveResult, PartInfo } from 'lit/directive.js';
...
export const cspStyleMap: (styleInfo: Readonly<StyleInfo>) => DirectiveResult<typeof CspStyleMapDirective> =
	directive(CspStyleMapDirective);
