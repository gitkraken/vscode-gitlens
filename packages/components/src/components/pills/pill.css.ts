...
export const baseStyles: CSSResult = css`
	...
	.pill {
		...
		color: var(--gl-pill-foreground, var(--color-ui-foreground, currentColor));
		text-transform: uppercase;
		white-space: nowrap;
		background-color: var(--gl-pill-background, var(--color-elevated-background, transparent));
	...
	.pill--outlined {
		...
		border: var(--gl-border-width) solid var(--gl-pill-border, var(--color-ui-foreground, currentColor));
	}
`;
