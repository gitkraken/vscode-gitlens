...
| `identity.js`                                      | Stable WIP-row creation and parsing                          |
| `projection.js`, `laneCollapse.js`, `scope.js`     | Incremental row projections                                  |
| `view.js`, `laneClamp.js`, `paging.js`, `stats.js` | Renderer-neutral view math                                   |
| `colors.js`, `a11y.js`, `theme.css`                | Palette, labels, and generic design tokens                   |
