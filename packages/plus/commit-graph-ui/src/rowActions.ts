import type { GraphRowOperationExecState } from './contracts/contributions.js';
...
export function statusIconFor(execState: GraphRowOperationExecState, hasResult: boolean = true): string | null {
	switch (execState) {
		case 'generating':
			return 'loading';
		case 'complete':
...
export function rowAdornmentTooltipFor(
	...
	execState: GraphRowOperationExecState | undefined,
...
export function chipStateSuffix(execState: GraphRowOperationExecState | undefined, hasResult: boolean = true): string {
	switch (execState) {
		case 'generating':
			return ' (Running)';
		case 'complete':
