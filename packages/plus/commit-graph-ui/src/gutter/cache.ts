...
import type { GutterMetrics, GutterRowSpan, NodeStyle } from './render.js';

/**
 * Per-`gl-commit-graph`-instance memo over the row gutter SVG (`renderGutterSvg`) — the runtime consumer
...
export const __test: { gutterRowKey: typeof gutterRowKey } = { gutterRowKey: gutterRowKey };
