 ...
 *
 * Note it is not a default every read has: GitHub's account-wide "my issues" read never requested an order, so
 * omitting `sort` there still leaves the provider's relevance order rather than adopting this.
 */
