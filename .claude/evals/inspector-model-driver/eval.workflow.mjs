...
const TASKS = [
	...
	},
	{
		id: 'T3',
		type: 'visual',
		setup: `launch({ workspace_path: "${REPO}", commands: ["gitlens.showGraphView"] }); resize_window({ width: 320, height: 900 })`,
		question: 'Any Commit Graph sidebar element overflowing at 320px width?',
	...
	},
	{
		...
		question: 'Cold Commit Graph hydration time, avg of 3 (updateComplete).',
