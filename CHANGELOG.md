...
- Adds a _Try Kepler_ banner to the _Agents_ section in _GitLens Settings_ and the _Commit Graph_'s _Agents_ side bar panel &mdash; introduces Kepler, the agent-agnostic development environment for running AI agents across the entire development workflow
