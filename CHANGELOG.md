...
- Adds right-click context menus to branch cards in the _Commit Graph side bar's _Overview_ panel &mdash; the same native branch menu the side bar's _Branches_ panel offers &mdash; and a _Start Work..._ button between the _Current work_ and _Recent_ groups
