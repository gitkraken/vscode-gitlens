...
- Adds new action buttons on many quick pick menu options, including in the _Git Command Palette_ &mdash; thanks to @tylerLeonhardt for the VS Code API support
