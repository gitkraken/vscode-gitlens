...
const headerText = `// This file is generated by (vscode-gitlens)/scripts/export-codicons.mjs
...
for (const [key, value] of Object.entries(icons)) {
	...
	tsMapEntries.push(`	${toTsProperty(key)}: '${numberToCssContent(value)}'`);
}
...
pending.push(fs.promises.writeFile('./packages/components/src/components/icons/codiconsMap.ts', ts));
