 ...
 *
 * Why 64-bit instead of 32-bit: the 32-bit variant's birthday-bound collision
 * probability (P ≈ 1 - e^(-k² / 2^33)) becomes problematic at scale — at 5M
 * users generating ~8,760 hourly tokens/year, ~10 users/year would experience
 * a consecutive-token collision.
 */
