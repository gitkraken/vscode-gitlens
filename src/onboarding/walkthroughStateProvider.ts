...
>([
	[
		...
		{
			usage: ['command:gitlens.showHomeView:executed'],
		},
	],
	[
		'graphParallelWork',
	...
	[
		'graphAiReview',
		{
			usage: ['command:gitlens.showCommitDetailsView:executed'],
		},
	],
	[
		'graphCompose',
		{
			usage: ['command:gitlens.showComposerPage:executed', 'action:gitlens.ai.generateCommits:happened'],
		},
	],
	[
		'graphCompare',
		{
			usage: ['command:gitlens.showSearchAndCompareView:executed'],
		},
	],
	[
		'graphNextSteps',
