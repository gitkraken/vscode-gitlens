...
export type CommandContext = ScmGroupsCommandContext | ScmStatesCommandContext | UnknownCommandContext | UriCommandContext | ViewCommandContext;
    ...
    protected _execute(...args: any[]): any {
        ...
        if (typeof this.run === 'function') {
            ...
            if (firstArg instanceof ExplorerNode) {
                ...
                return this.run({ type: 'view', node: node }, ...rest);
            }
