...
export const generateRebaseMultiStep1UserPrompt = `You are an advanced AI programming assistant tasked with explaining code changes and how they would be best organized into commits. Your goal is to examine a unified diff of the code changes and explain the changes and how they should be grouped into a set of commits.
...
export const generateRebaseMultiStep2UserPrompt = `Using the plan you provided in the previous step, your goal now is use it to create that new set of commits, ensuring that ALL the changes in the unified diff are included in the new set of commits.
