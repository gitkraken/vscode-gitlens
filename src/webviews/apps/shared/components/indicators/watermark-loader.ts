...
export class GlWatermarkLoader extends LitElement {
	...
	override render(): unknown {
		const watermarkClass = `watermark${this.pulse ? ' watermark--pulse' : ''}`;
		return html`<div class="container">
			<div class="${watermarkClass}">
				${watermarkPaths.map(
					d =>
						html`<div class="watermark-piece">
