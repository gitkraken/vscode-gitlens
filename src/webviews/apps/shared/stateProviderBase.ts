	...
	implements Disposable
{
	...
	//  * Called when state changes from messages or initialization.
	//  */
	// protected updateState(newState: State, silent?: boolean): void {
	// 	this._state = { ...newState, timestamp: Date.now() };
