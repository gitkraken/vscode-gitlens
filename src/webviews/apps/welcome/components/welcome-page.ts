...
const graphWalkthroughSteps: GraphWalkthroughStep[] = [
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.showHomeView">Open the Overview Sidebar</gl-button>
			</div>
		`,
	},
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.showGraph">Focus the Commit Graph</gl-button>
			</div>
		`,
	},
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.showCommitDetailsView">Try Review Mode</gl-button>
			</div>
		`,
	},
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.welcome.showComposer">Try Compose Mode</gl-button>
			</div>
		`,
	},
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.showSearchAndCompareView">Open Compare Mode</gl-button>
			</div>
		`,
	},
	{
		...
		body: html`
			...
			<div class="card-part--centered">
				<gl-button href="command:gitlens.showHomeView">See My Working Changes</gl-button>
			</div>
		`,
	},
];
