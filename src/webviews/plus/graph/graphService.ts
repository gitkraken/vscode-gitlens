...
export interface GraphInspectService {
	...
	/** Stops a running automatic rebase. `abort` aborts the rebase and restores the pre-rebase state;
	 *  `detach` stops automating but leaves the rebase paused at the current step, keeping the steps
	 *  already completed. */
