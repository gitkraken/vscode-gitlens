...
// ============================================================
// Shared param types (used by RPC service methods + components)
// ============================================================
...
// ============================================================
// RPC Service Interface (Supertalk)
// ============================================================
...
export interface TimelineDatasetResult {
	...
	repository: (RepositoryShape & { ref: GitReference | undefined }) | undefined;
	/** Repository counts (for "switch repo" affordance). */
	repositoryCounts: { count: number; openCount: number };
	/** Feature access for the scope's repo. */
	access: FeatureAccess;
}

/** RPC services for the Timeline webview. */
export interface TimelineServices extends CommonWebviewServices {
	// --- Lifecycle ---
	...
	getDataset(scope: TimelineScopeSerialized, config: TimelineConfig): Promise<TimelineDatasetResult>;
