...
export function isDetailsItemTypedContext(
	item: unknown,
	type: 'change',
): item is DetailsItemTypedContext<DetailsChangeContextValue>;
export function isDetailsItemTypedContext(
	item: unknown,
...
export function isDetailsChangeContext(item: unknown): item is DetailsItemTypedContext<DetailsChangeContextValue> {
	if (item == null) return false;

	return isDetailsItemTypedContext(item, 'change');
}
