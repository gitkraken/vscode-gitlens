...
export const deepLinkStateToProgress: Record<string, DeepLinkProgress> = {
	[DeepLinkServiceState.Idle]: { message: l10n.t('Done.'), increment: 100 },
	[DeepLinkServiceState.AccountCheck]: { message: l10n.t('Checking account...'), increment: 1 },
	[DeepLinkServiceState.PlanCheck]: { message: l10n.t('Checking plan...'), increment: 2 },
	[DeepLinkServiceState.TypeMatch]: { message: l10n.t('Matching link type...'), increment: 5 },
	[DeepLinkServiceState.RepoMatch]: { message: l10n.t('Finding a matching repository...'), increment: 10 },
	[DeepLinkServiceState.CloneOrAddRepo]: { message: l10n.t('Adding repository...'), increment: 20 },
	[DeepLinkServiceState.AddedRepoMatch]: { message: l10n.t('Finding a matching repository...'), increment: 25 },
	[DeepLinkServiceState.RemoteMatch]: { message: l10n.t('Finding a matching remote...'), increment: 30 },
	[DeepLinkServiceState.AddRemote]: { message: l10n.t('Adding remote...'), increment: 40 },
	[DeepLinkServiceState.TargetMatch]: { message: l10n.t('finding a matching target...'), increment: 50 },
	[DeepLinkServiceState.Fetch]: { message: l10n.t('Fetching...'), increment: 60 },
	[DeepLinkServiceState.FetchedTargetMatch]: { message: l10n.t('Finding a matching target...'), increment: 65 },
	[DeepLinkServiceState.MaybeOpenRepo]: { message: l10n.t('Opening repository...'), increment: 70 },
	[DeepLinkServiceState.RepoOpening]: { message: l10n.t('Opening repository...'), increment: 75 },
	[DeepLinkServiceState.GoToTarget]: { message: l10n.t('Opening target...'), increment: 80 },
	[DeepLinkServiceState.OpenGraph]: { message: l10n.t('Opening graph...'), increment: 90 },
	[DeepLinkServiceState.OpenComparison]: { message: l10n.t('Opening comparison...'), increment: 90 },
	[DeepLinkServiceState.OpenDraft]: { message: l10n.t('Opening cloud patch...'), increment: 90 },
	[DeepLinkServiceState.OpenWorkspace]: { message: l10n.t('Opening workspace...'), increment: 90 },
	[DeepLinkServiceState.OpenFile]: { message: l10n.t('Opening file...'), increment: 90 },
	[DeepLinkServiceState.OpenWorkingChanges]: { message: l10n.t('Opening working changes...'), increment: 90 },
	[DeepLinkServiceState.SwitchToRef]: { message: l10n.t('Switching to ref...'), increment: 90 },
	[DeepLinkServiceState.RunCommand]: { message: l10n.t('Running command...'), increment: 90 },
	[DeepLinkServiceState.OpenAllPrChanges]: { message: l10n.t('Opening all PR changes...'), increment: 90 },
	[DeepLinkServiceState.DeleteBranch]: { message: l10n.t('Deleting branch...'), increment: 90 },
	[DeepLinkServiceState.ConnectCloudIntegrations]: {
		message: l10n.t('Connecting cloud integrations...'),
		increment: 90,
	},
	[DeepLinkServiceState.StartReview]: { message: l10n.t('Starting review...'), increment: 90 },
	[DeepLinkServiceState.StartWork]: { message: l10n.t('Starting work...'), increment: 90 },
};
