...
import { getHostAgentId, getSelectableAgents } from './mcpAgents.js';
...
export async function showMcpAgentPicker(
	...
	const hostAgentId = getHostAgentId(hostAppName);
	const agents = await getSelectableAgents(hostAgentId, cliPath);
