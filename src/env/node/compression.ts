 ...
 * a webview from different builds still understand each other. The browser counterpart returns
 * `undefined` — compression is unavailable there (the web-worker host and webview never cross a network).
 */
export function deflateRaw(data: Uint8Array): Uint8Array | undefined {
