...
export interface TelemetryEvents extends WebviewShowAbortedEvents, WebviewShownEvents, WebviewClosedEvents {
	...
	/** Sent when the user clicks Open Session, View Plan, or Open Terminal in the sidebar agents panel */
	...
	/** Sent when the user types in the filter box in the sidebar agents panel */
