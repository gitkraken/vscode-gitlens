...
const quoteRegex = /"/g;
/** Backslashes and double quotes, escaped in one pass so neither escape re-escapes the other */
const tooltipEscapeRegex = /[\\"]/g;
const newlineRegex = /\r?\n/g;
const lineStartRegex = /^/gm;

function escapeMarkdownTooltip(value: string): string {
	return value.replace(tooltipEscapeRegex, '\\$&');
}
